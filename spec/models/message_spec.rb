...
RSpec.describe Message, type: :model do
  ...
  describe "validations" do
    ...
    it "is valid if the body is 300 characters or fewer" do
      user1 = User.create!(name: 'John Doe', email: 'john@example.com', phone_number: '11234567890')
      user2 = User.create!(name: 'Gary', email: 'gary23@email.com', phone_number: '11234567891')
      conversation = Conversation.create!(name: 'General Chat')
    ...
    it "is valid with a body and recipients" do
      user1 = User.create!(name: "John Doe", email: "john@example.com", phone_number: "11234567890")
      user2 = User.create!(name: "Jane Doe", email: "jane@example.com", phone_number: "19876543210")
      conversation = Conversation.create!(name: "General Chat")
